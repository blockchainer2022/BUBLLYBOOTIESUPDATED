            ...
            <main className="page-wrapper">
                        ...
                        <div className="row row--30 align-items-center">
                            <div className="order-2 order-lg-1 col-lg-6 mt_md--50 mt_sm--50 mt_lg--30">
                                <div className="inner text-left">
                                    <img className="w-70 mt--15 mb--20" src="./images/logo/logo-section-dark.png" alt="Banner Images" />
                                    <p className="description color-blackest">Bubbly Booties is a unique collection of 10,000 hand illustrated and randomly generated NFTs living on The Bootyverse.</p>
                                    <div className="button-group mt--30 mt_sm--20">
                                        <a className="btn-default btn-medium btn-icon" href="/mint">Mint</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6 order-1 order-lg-2">
                                    ...
                                    <div class="sprite-display-none"><video autoPlay loop muted class="img-rounded img-dropshadow"><source src="./images/animation/sprite.mp4" type="video/mp4"></source></video></div>
                ...
                <div className="rwt-team-area rn-section-gap">
                    <div className="container">
                        ...
                        <TeamThree column="col-lg-3 col-md-6 col-6 mt--30" teamStyle="team-style-two" />
                    </div>
                </div>
                {/* End Elements Area  */}
                <Separator />
